...
func TestProviderCreate(t *testing.T) {
	...
	foundProv, found := keeper.GetProviderAttributes(ctx, id)
...
func TestProviderDeleteExistingAttributes(t *testing.T) {
	...
	err = keeper.DeleteProviderAttributes(ctx, id, prov.Attributes[0:1])
	require.NoError(t, err)
...
func TestProviderDeleteNonExistingAttributes(t *testing.T) {
	...
	err = keeper.DeleteProviderAttributes(ctx, id, testutil.Attributes(t))
	require.Error(t, err)
}
